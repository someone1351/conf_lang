        ...
        .branch("root_branch")
            ...
            .tag_nodes(["include"])
                .entry()
                    .param_any()
            .tag_nodes(["hello"])
                .rentry_children("root_branch")
                    .group().group_label("ints").group_optional().group_repeat()
                        .param_parse::<i32>()
                        .param_parse::<i32>()
                    .group().group_label("the opt int").group_optional()
                        .param_parse::<i32>()
                    .group().group_label("the int")
                        .param_parse::<i32>()
                        .param_parse::<i32>()
                    .group().group_label("the any")
                        .param_any()
            .tag_nodes(["functest"])
                .entry()
                    .group().group_repeat()
...
fn walk_test2() {
    let def = conf_lang::Def::new()
        .group().group_repeat()
            .param_parse::<bool>()
        .group().group_optional().group_repeat()
            .param_parse::<i32>()
            // .param_optional()
            // .param_parse::<i32>()
            // .param_parse::<i32>()
