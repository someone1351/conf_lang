        ...
        .branch("root_branch")
            ...
            .tags(["hello"])
                .entry_children("root_branch")
                    .rgroup().label_group("ints").optional_group().repeat_group()
                        .param_parse::<i32>()
                        .param_parse::<i32>()
                    .rgroup().label_group("the opt int").optional_group()
                        .param_parse::<i32>()
                    .rgroup().label_group("the int")
                        .param_parse::<i32>()
                        .param_parse::<i32>()
                    .group().label_group("the any")
                        .param_any()
            .tags(["functest"])
                .entry()
                    .group().repeat_group()
...
fn walk_test2() {
    let def = conf_lang::Def::new()
        .group().repeat_group()
            .param_parse::<bool>()
        .rgroup().optional_group().repeat_group()
            .param_parse::<i32>()
            // .param_optional()
            // .param_parse::<i32>()
            // .param_parse::<i32>()
