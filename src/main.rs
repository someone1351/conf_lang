        ...
        .branch("root_branch")
            ...
            .tags(["hello"])
                .entry_children("root_branch")
                    .rgroup().group_label("ints").group_optional().group_repeat()
                        .param_parse::<i32>()
                        .param_parse::<i32>()
                    .rgroup().group_label("the opt int").group_optional()
                        .param_parse::<i32>()
                    .rgroup().group_label("the int")
                        .param_parse::<i32>()
                        .param_parse::<i32>()
...
fn walk_test2() {
    let def = conf_lang::Def::new()
        .group().group_repeat()
            .param_parse::<bool>()
        .rgroup().group_optional().group_repeat()
            .param_parse::<i32>()
            // .param_optional()
            // .param_parse::<i32>()
            // .param_parse::<i32>()
